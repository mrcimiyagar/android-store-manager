...
public class ItemTypePickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_type_picker);

        this.recyclerView = findViewById(R.id.activity_item_type_picker_recycler_view);
        ...
        this.recyclerView.setAdapter(new ItemTypesAdapter(Core.getInstance().getDatabaseHelper().getItemTypes()
                , new OnItemTypeSelectedListener() {
            @Override
            public void itemTypeSelected(ItemType itemType) {
                setResult(RESULT_OK, new Intent().putExtra("item-type", itemType));
                finish();
            }
        }));
    }
